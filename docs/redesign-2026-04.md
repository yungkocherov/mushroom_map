...
**TODO до старта фазы 1:** проверить доступность домена `geobiom.ru` (если занят — выбрать альтернативу до коммита бренда в OG-теги).
...
- [ ] **Проверить домен** — `geobiom.ru` доступен? Если занят — альтернатива должна быть выбрана до фазы 2 (нужно для OG/SEO-обновления главной).
