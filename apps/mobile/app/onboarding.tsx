...
const SLIDES: { id: SlideId; title: string; lead: string; cta: string }[] = [
  {
    ...
    lead:
      "Карта лесных выделов с породами и возрастом. Сохрани грибное место по GPS, открой его потом стрелкой-компасом. Всё работает без сети — заранее скачай нужные районы.",
    cta: "Дальше",
  },
  {
    id: "gps",
    title: "Доступ к GPS",
    lead:
      "Чтобы показать твою точку на лесной карте и расстояние до сохранённых мест, нужен доступ к местоположению. Используется только когда приложение открыто. Никаких данных в облако без логина.",
    cta: "Разрешить",
  },
  {
    id: "save",
    title: "Как сохранить место",
    lead:
      "Нажми на лесной выдел и «Сохранить место» — или удерживай палец в любой точке карты. Откроется форма с координатами, рейтингом, тегами деревьев и грибов, заметкой и фото.",
    cta: "Понятно",
  },
  {
    id: "regions",
