/**
 * LandingMapCameo — статический SVG-стилизованный preview карты ЛО на
 * лендинге.
 *
 * V4.5 (redesign-2026-05-11): MapLibre+pmtiles полностью убраны. Юзер
 * пожаловался что cameo долго грузится (forest.pmtiles ~500MB range-
 * fetch, scheme-style fetch, woff2 fonts) — для лендинга это
 * overkill. Теперь это чистый SVG: фон + Финский залив + Ладога +
 * forest blobs + дороги + подписи + 3 pulse-pin'а. Source-of-truth —
 * `docs/redesign-2026-05/claude-design/src/shared.jsx:StylizedMap`,
 * портировано на TS без изменения визуальной семантики.
 */
...
// Цветовая палитра — D1V tokens из дизайн-эталона.
const BG          = "#ede1c8";
const WATER       = "#a9bccc";
const FOREST      = "#7d8e5a";
