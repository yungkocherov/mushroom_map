...
DISTRICT_PATTERNS: dict[str, dict] = {
    ...
    "Волосовский район": {"kind": "district_lo", "patterns": [
        r"\bволосовск\w*",
        r"\bволосов(?:о|а|ом|ыми|ых|ыми|е|у)?\b",   # все падежи Волосово
        r"\bбегуниц\w*",
    ]},
    ...
    "Всеволожский район": {"kind": "district_lo", "patterns": [
        ...
        r"\bсертолов\w*",
        r"\bромашк\w+\s+оз",
        r"\bдевяткин\w*",                              # Девяткино, Новое Девяткино
        r"\bкудров\w*",                                 # Кудрово
        r"\bосельки\b",                                 # Осельки
    ]},
    "Выборгский район": {"kind": "district_lo", "patterns": [
        r"\bвыборгск\w*",
        r"\bвыборг(?:а|у|е|ом)?\b",                  # Выборг, Выборга, Выборгу, Выборге, Выборгом
        r"\bрощин\w*",
        r"\bзеленогорск\w*",
        r"\bкирилловск\w*",
        r"\bзаходск\w*",                              # Заходское/в Заходском
        # Первомайск (посёлок) — только конкретные формы посёлка,
        # НЕ просто «\bпервомайск\w*»: тот ложно ловит «Первомайские полянки»,
        # «Первомайская улица» и т.п. (повсеместный советский топоним).
        r"\bпервомайск(?:ое|ом)\b",
    ]},
    "Гатчинский муниципальный округ": {"kind": "district_lo", "patterns": [
        r"\bгатчинск\w*",
        r"\bгатчин(?:а|у|ы|е|ой|ою)?\b",             # Гатчина, Гатчине, Гатчиной
        r"\bвырицк?\w*",
        r"\bсиверск\w*",
        r"\bкоммунарск?\w*",
        r"\bверевск\w*",
        r"\bорлин\w*",
        r"\bдружн\w*\s+г",
        r"\bкобринск\w*",                              # Кобринское (посёлок Гатчинского)
    ]},
    "Кингисеппский район": {"kind": "district_lo", "patterns": [
        r"\bкингисепп?ск\w*",
        r"\bкингисепп?(?:а|у|е|ом)?\b",
        r"\bивангород\w*",
        r"\bусть[- ]лу\w*",
    ]},
    "Киришский район": {"kind": "district_lo", "patterns": [
        r"\bкиришск\w*",
        r"\bкириш(?:и|ей|ам|ах|ами|у|е)?\b",          # Кириши, Киришей, Киришам
    ]},
    "Кировский район": {"kind": "district_lo", "patterns": [
        r"\bкировск\w*\s+р",                          # «Кировский район»
        r"\bкировск(?:а|у|е|ом)?\b",                  # Кировск-город (все формы)
        r"\bмга\b",
        r"\bшлиссельбург\w*",
        r"\bпутилов\w*",
        r"\bсинявин\w*",
    ...
    "Ломоносовский район": {"kind": "district_lo", "patterns": [
        ...
        r"\bбольшая\s+ижор\w*",
        r"\bкопорск?\w*",
        r"\bкопор(?:ье|ья|ью|ьем)\b",                  # Копорье (село)
    ]},
    ...
    "Подпорожский район": {"kind": "district_lo", "patterns": [
        r"\bподпорожск\w*",
        r"\bподпорож(?:ье|ья|ью|ьем)?\b",
        r"\bвознесен\w*\s+пос",
    ]},
    "Приозерский район": {"kind": "district_lo", "patterns": [
        r"\bприозерск\w*",
        r"\bприозерк[аеу]?\b",                         # Приозерка (разг.), Приозерке, Приозерку
        r"\bлосев\w*",
        r"\bорехов\w*",
        r"\bсосново\b",
        r"\bпетяярв\w*",
    ...
    "Сосновоборский городской округ": {"kind": "district_lo", "patterns": [
        r"\bсосновоборск\w*",
        r"\bсосновый\s+бор\b",
        r"\bсосново\w*\s+бор\w*",                      # Сосновый Бор / Соснового Бора / Сосновом Бору
    ]},
    "Тихвинский район": {"kind": "district_lo", "patterns": [
        r"\bтихвинск\w*",
        r"\bтихвин(?:а|у|е|ом)?\b",                  # Тихвин, Тихвина, Тихвине, Тихвином
    ]},
    "Тосненский район": {"kind": "district_lo", "patterns": [
        r"\bтосненск\w*",
        r"\bтосн(?:о|а|е|у|ом)\b",                   # Тосно, Тосна, Тосне, Тосном
        r"\bлюбан\w*",
        r"\bульяновк\w*",
        r"\bфорносов\w*",
        r"\bноволисин\w*",                            # Новолисино
        r"\bрябов[оае]?\b",                           # Рябово (Тосненский)
    ]},
    ...
    "Новгородская область": {"kind": "subject_ru", "patterns": [
        ...
        r"\bстарая\s+русса\b",
        r"\bваллдай\w*",
        r"\bборович(?:и|ах|ам|ей|и|ского|ский)\b",     # Боровичи / Боровичского / Боровичский
        r"\bборовический\b",                            # частая опечатка «Боровичский»
    ]},
    ...
    "СПб: Курортный район": {"kind": "district_spb", "patterns": [
        ...
        r"#курортн\w*",                            # #Курортный, #курортныйрайон, #курортный@grib_spb
        r"\bсестрорецк\w*",
        r"\bзеленогорск\w*\s+(?:пос|парк|пляж)",   # Зеленогорск тоже в Курортном СПб
        r"\bрепино\b",
        r"\bкомарово\b",
        r"\bлисий\s+нос\w*",                          # Лисий Нос
        r"\bушков[оае]?\b",                           # Ушково
        r"\bбелоостров\w*",                           # Белоостров
        r"\bдибуны\b",                                # Дибуны
    ]},
    "СПб: Петродворцовый район": {"kind": "district_spb", "patterns": [
        r"\bпетродворц\w*",
        r"\bпетергоф\w*",
        r"\bстрельн(?:а|е|у|ой)\b",                  # Стрельна (избегаем коллизий с «стрелка»)
        # Ломоносов город (Петродворцовый СПб) — НЕ пишем во избежание
        # ложного матча с фамилией Ломоносов.
    ]},
    "СПб: Красногвардейский район": {"kind": "district_spb", "patterns": [
        r"\bкрасногвардейск\w+\s+р(?:айон)?",
        r"#красногвардейск\w*",
        r"\bохт(?:а|е|у|ой)\b",                       # Охта (район)
        r"\bновая\s+охта\b",
        r"\bпороховые\b",
        r"\bржевк[ае]?\b",
    ]},
    "СПб: Приморский район": {"kind": "district_spb", "patterns": [
        ...
        r"#приморский\w*",                          # #Приморский, #приморский@grib_spb
    ...
    "СПб: Колпинский район": {"kind": "district_spb", "patterns": [
        ...
        r"#колпинск\w*",
        r"\bметаллострой\w*",
        # «Саперный карьер/полигон/посёлок» — Колпинский СПб (часто упоминают
        # грибники как место сбора). Двусторонний контекст: «карьер Саперный»
        # или «Саперный карьер», тоже genitive/инструментал.
        r"\b(?:карьер|полигон|пос\w*|за|в)\s+саперн\w+",
        r"\bсаперн\w+\s+(?:карьер|полигон|пос\w*)",
    ]},
    "СПб: Пушкинский район": {"kind": "district_spb", "patterns": [
        r"\bпушкинск\w+\s+р(?:айон)?",
        r"#пушкинский\w*",                          # #Пушкинский, #пушкинский@grib_spb
        r"\bцарское\s+село\b",
        r"\bпавловск\w*",
        r"\bпушкин\b",                                # «г. Пушкин»
        r"\bекатериненский\s+парк\b",                 # Екатеринский парк (Пушкин)
        r"\bалександровский\s+парк\b",                # Александровский парк (Пушкин)
    ]},
    "СПб: Красносельский район": {"kind": "district_spb", "patterns": [
        r"\bкрасносельск\w*",
        r"\bкрасное\s+село\b",                        # Красное село
    ]},
    ...
    "СПб: Кронштадтский район": {"kind": "district_spb", "patterns": [
        r"\bкронштадт\w*",                              # Кронштадт, Кронштадта, Кронштадтский
        r"\bфорт\s+(?:шанц|александр|тотлебен|обручев|константин|павел|петр|николай)\w*",
    ]},
    "СПб: Выборгский район": {"kind": "district_spb", "patterns": [
        r"#выборгский\s+район\s+спб\b",
